...
func (bt basicTestTxn) generateTxn(t *testing.T) *MsgDeSoTxn {
	t.Helper()
	txn := &MsgDeSoTxn{
...
func (txn derivedKeyTestTxn) generateTxn(t *testing.T) *MsgDeSoTxn {
	t.Helper()
	derivedKeyTxn, derivedPrivKey := doDerivedKeyTransaction(t, txn.transactionSpendingLimit)
