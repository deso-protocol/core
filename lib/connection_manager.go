...
func NewConnectionManager(
	_params *types.DeSoParams, _addrMgr *addrmgr.AddrManager, _listeners []net.Listener,
...
func IPToNetAddr(ipStr string, addrMgr *addrmgr.AddrManager, params *types.DeSoParams) (*wire.NetAddress, error) {
