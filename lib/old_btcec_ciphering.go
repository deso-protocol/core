...
// Note: this is a copy of the ciphering file
// from the v0.21.0-beta release of btcec. We
// have copied it here as some of the functionality
// was removed in newer releases, but we needed to
// upgrade. Thus we use these functions to ensure
...
func LegacyBtcecEncrypt(pubkey *btcec.PublicKey, in []byte) ([]byte, error) {
...
func LegacyBtcecDecrypt(priv *btcec.PrivateKey, in []byte) ([]byte, error) {
