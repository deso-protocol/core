...
func TestGetSafeBlocks(t *testing.T) {
	...
	err = testMeta.chain.storeValidatedBlockInBlockIndex(block1)
	require.NoError(t, err)
	...
	require.NoError(t, err)
	err = testMeta.chain.storeValidatedBlockInBlockIndex(block2)
	require.NoError(t, err)
	...
	err = testMeta.chain.storeValidatedBlockInBlockIndex(block3)
	require.NoError(t, err)
	...
	err = testMeta.chain.storeBlockInBlockIndex(block3Prime)
	require.NoError(t, err)
	...
	err = testMeta.chain.storeValidatedBlockInBlockIndex(block3Prime)
	require.NoError(t, err)
	safeBlocks, err = testMeta.chain.GetSafeBlocks()
	require.NoError(t, err)
