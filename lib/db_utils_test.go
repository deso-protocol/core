...
func TestPrivateMessages(t *testing.T) {
	...
	message1 := &MessageEntry{
		...
		TstampNanos:                 tstamp1,
		Version:                     1,
		SenderAccessPublicKey:       NewPublicKey(pk1),
		SenderAccessGroupKeyName:    BaseGroupKeyName(),
		RecipientAccessPublicKey:    NewPublicKey(pk2),
	...
	message2 := &MessageEntry{
		...
		TstampNanos:                 tstamp2,
		Version:                     1,
		SenderAccessPublicKey:       NewPublicKey(pk2),
		SenderAccessGroupKeyName:    BaseGroupKeyName(),
		RecipientAccessPublicKey:    NewPublicKey(pk1),
		RecipientAccessGroupKeyName: BaseGroupKeyName(),
	}
	message3 := &MessageEntry{
		...
		TstampNanos:                 tstamp3,
		Version:                     1,
		SenderAccessPublicKey:       NewPublicKey(pk3),
		SenderAccessGroupKeyName:    BaseGroupKeyName(),
		RecipientAccessPublicKey:    NewPublicKey(pk1),
		RecipientAccessGroupKeyName: BaseGroupKeyName(),
	}
	...
	message5 := &MessageEntry{
		...
		SenderAccessPublicKey:       NewPublicKey(pk1),
		SenderAccessGroupKeyName:    BaseGroupKeyName(),
		RecipientAccessPublicKey:    NewPublicKey(pk3),
		RecipientAccessGroupKeyName: BaseGroupKeyName(),
	}
