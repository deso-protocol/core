...
type DBPrefixes struct {
	...
	// Prefix, TotalStakeAmountNanos, MaxUint64 - RegisteredAtBlockHeight, ValidatorPKID -> nil
	//
	...
	//
	// Also note that we save space by storing a nil value and parsing the ValidatorPKID from the key.
