...
CREATE TABLE pg_blocks (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    hash              CHAR(54) NOT NULL,
    parent_hash       CHAR(54),
    height            BIGINT NOT NULL,
    difficulty_target CHAR(54)  NOT NULL,
    cum_work          CHAR(54)  NOT NULL,
    status            TEXT   NOT NULL,
    tx_merkle_root    CHAR(54)  NOT NULL,
...
CREATE TABLE pg_metadata_block_rewards (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    transaction_hash CHAR(54) NOT NULL,
    extra_data       CHAR(54) NOT NULL,
...
CREATE TABLE pg_metadata_bitcoin_exchanges (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    transaction_hash    CHAR(54) NOT NULL,
    bitcoin_block_hash  CHAR(54) NOT NULL,
    bitcoin_merkle_root CHAR(54) NOT NULL,
...
CREATE TABLE pg_metadata_private_messages (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    transaction_hash     CHAR(54)  NOT NULL,
    recipient_public_key CHAR(56)  NOT NULL,
...
CREATE TABLE pg_metadata_submit_posts (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    transaction_hash    CHAR(54)  NOT NULL,
    post_hash_to_modify CHAR(54)  NOT NULL,
    parent_stake_id     CHAR(54)  NOT NULL,
...
CREATE TABLE pg_metadata_update_profiles (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    transaction_hash         CHAR(54) NOT NULL,
    profile_public_key       CHAR(56),
    new_username             CHAR(54),
    new_description          CHAR(54),
...
CREATE TABLE pg_metadata_follows (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    transaction_hash    CHAR(54) NOT NULL,
    followed_public_key CHAR(56) NOT NULL,
...
CREATE TABLE pg_metadata_likes (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    transaction_hash CHAR(54) NOT NULL,
    liked_post_hash  CHAR(54) NOT NULL,
...
CREATE TABLE pg_metadata_creator_coins (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    transaction_hash                CHAR(54) NOT NULL,
    profile_public_key              CHAR(56) NOT NULL,
...
CREATE TABLE pg_metadata_swap_identities (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    transaction_hash CHAR(54) NOT NULL,
    from_public_key  CHAR(56) NOT NULL,
    to_public_key    CHAR(56) NOT NULL,
...
CREATE TABLE pg_metadata_creator_coin_transfers (
    ...
    receiver_public_key            CHAR(56) NOT NULL,
...
CREATE TABLE pg_metadata_create_nfts (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    transaction_hash             CHAR(54) NOT NULL,
    nft_post_hash                CHAR(54) NOT NULL,
...
CREATE TABLE pg_metadata_accept_nft_bids (
    ...
    nft_post_hash    CHAR(54) NOT NULL,
    serial_number    BIGINT NOT NULL,
    bidder_pkid      CHAR(56) NOT NULL,
    bid_amount_nanos BIGINT NOT NULL,
    unlockable_text  CHAR(54) NOT NULL,
...
CREATE TABLE pg_notifications (
    ...
    transaction_hash CHAR(54) NOT NULL,
    mined            BOOL NOT NULL,
    to_user          CHAR(54) NOT NULL,
    from_user        CHAR(54) NOT NULL,
    other_user       CHAR(54),
    type             SMALLINT NOT NULL,
    amount           BIGINT,
    post_hash        CHAR(54),
...
CREATE TABLE pg_posts (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    post_hash                    CHAR(54) NOT NULL,
    poster_public_key            CHAR(56) NOT NULL,
    parent_post_hash             CHAR(54),
    body                         MEDIUMTEXT,
    reposted_post_hash           CHAR(54),
    quoted_repost                BOOL,
    timestamp                    BIGINT,
    hidden                       BOOL,
    like_count                   BIGINT,
...
CREATE TABLE pg_likes (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    liker_public_key CHAR(56) NOT NULL,
    liked_post_hash  CHAR(54) NOT NULL,
...
CREATE TABLE pg_follows (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    follower_pkid CHAR(56) NOT NULL,
    followed_pkid CHAR(56) NOT NULL,
...
CREATE TABLE pg_diamonds (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    sender_pkid       CHAR(56) NOT NULL,
    receiver_pkid     CHAR(56) NOT NULL,
    diamond_post_hash CHAR(54) NOT NULL,
...
CREATE TABLE pg_messages (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    message_hash         CHAR(54) NOT NULL,
    sender_public_key    CHAR(56),
    recipient_public_key CHAR(56),
...
CREATE TABLE pg_creator_coin_balances (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    holder_pkid   CHAR(56) NOT NULL,
    creator_pkid  CHAR(56) NOT NULL,
...
CREATE TABLE pg_reposts (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    reposter_public_key CHAR(56) NOT NULL,
    reposted_post_hash  CHAR(54) NOT NULL,
    repost_post_hash    CHAR(54),
...
CREATE TABLE pg_metadata_derived_keys (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
    transaction_hash   CHAR(54) NOT NULL,
    derived_public_key CHAR(56) NOT NULL,
    expiration_block   BIGINT NOT NULL,
    operation_type     SMALLINT NOT NULL,
    access_signature   CHAR(54) NOT NULL,
