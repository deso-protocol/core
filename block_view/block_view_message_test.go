...
func TestPrivateMessage(t *testing.T) {
	...
	require.Error(err)
	require.Contains(err.Error(), types.RuleErrorPrivateMessageSenderPublicKeyEqualsRecipientPublicKey)
	...
	require.Error(err)
	require.Contains(err.Error(), types.RuleErrorPrivateMessageEncryptedTextLengthExceedsMax)
	...
	require.Error(err)
	require.Contains(err.Error(), types.RuleErrorPrivateMessageTstampIsZero)
	...
	require.Error(err)
	require.Contains(err.Error(), types.RuleErrorPrivateMessageExistsWithSenderPublicKeyTstampTuple)
	...
	require.Error(err)
	require.Contains(err.Error(), types.RuleErrorPrivateMessageExistsWithRecipientPublicKeyTstampTuple)
	...
	//    m3: 2
	{
		...
		decryptedBytes, err := network.DecryptBytesWithPrivateKey(messageEntry.EncryptedText, priv.ToECDSA())
		require.NoError(err)
