...
type DeSoParams struct {
	...
	GenesisBlock *network.MsgDeSoBlock
	...
	ParamUpdaterPublicKeys      map[block_view.PkMapKey]bool
	...
	SeedBalances []*network.DeSoOutput
...
func (params *DeSoParams) EnableRegtest() {
	...
	params.ParamUpdaterPublicKeys[block_view.MakePkMapKey(MustBase58CheckDecode("tBCKVERmG9nZpHTk2AVPqknWc1Mw9HHAnqrTpW1RnXpXMQ4PsQgnmV"))] = true
}
...
var (
	...
	ParamUpdaterPublicKeys = map[block_view.PkMapKey]bool{
		...
		block_view.MakePkMapKey(MustBase58CheckDecode(ArchitectPubKeyBase58Check)):                                true,
		block_view.MakePkMapKey(MustBase58CheckDecode("BC1YLiXwGTte8oXEEVzm4zqtDpGRx44Y4rqbeFeAs5MnzsmqT5RcqkW")): true,
		block_view.MakePkMapKey(MustBase58CheckDecode("BC1YLgGLKjuHUFZZQcNYrdWRrHsDKUofd9MSxDq4NY53x7vGt4H32oZ")): true,
		block_view.MakePkMapKey(MustBase58CheckDecode("BC1YLj8UkNMbCsmTUTx5Z2bhtp8q86csDthRmK6zbYstjjbS5eHoGkr")): true,
		block_view.MakePkMapKey(MustBase58CheckDecode("BC1YLgD1f7yw7Ue8qQiW7QMBSm6J7fsieK5rRtyxmWqL2Ypra2BAToc")): true,
		block_view.MakePkMapKey(MustBase58CheckDecode("BC1YLfz4GH3Gfj6dCtBi8bNdNTbTdcibk8iCZS75toUn4UKZaTJnz9y")): true,
		block_view.MakePkMapKey(MustBase58CheckDecode("BC1YLfoSyJWKjHGnj5ZqbSokC3LPDNBMDwHX3ehZDCA3HVkFNiPY5cQ")): true,
	}
)
...
var DeSoMainnetParams = DeSoParams{
	...
	BitcoinStartBlockNode: NewBlockNode(
		...
		653184,
		DifficultyBitsToHash(386798414),
...
var DeSoTestnetParams = DeSoParams{
	...
	BitcoinStartBlockNode: NewBlockNode(
		...
		1897056,
		DifficultyBitsToHash(424073553),
...
var (
	InitialGlobalParamsEntry = block_view.GlobalParamsEntry{
...
func DifficultyBitsToHash(diffBits uint32) (_diffHash *BlockHash) {
	diffBigint := blockchain.CompactToBig(diffBits)
