...
type PGTransaction struct {
	...
	Type      network.TxnType `pg:",use_zero"`
...
type PGTransactionOutput struct {
	...
	OutputType  block_view.UtxoType `pg:",use_zero"`
...
func (utxo *PGTransactionOutput) NewUtxoEntry() *block_view.UtxoEntry {
	return &block_view.UtxoEntry{
...
type PGMetadataCreatorCoin struct {
	...
	TransactionHash             *BlockHash                       `pg:",pk,type:bytea"`
	ProfilePublicKey            []byte                           `pg:",type:bytea"`
	OperationType               network.CreatorCoinOperationType `pg:",use_zero"`
...
type PGMetadataDerivedKey struct {
	...
	OperationType    network.AuthorizeDerivedKeyOperationType `pg:",use_zero"`
...
func (post *PGPost) NewPostEntry() *block_view.PostEntry {
	postEntry := &block_view.PostEntry{
...
func (post *PGPost) HasMedia() bool {
	bodyJSONObj := network.DeSoBodySchema{}
...
func (like *PGLike) NewLikeEntry() *block_view.LikeEntry {
	return &block_view.LikeEntry{
...
func (follow *PGFollow) NewFollowEntry() *block_view.FollowEntry {
	return &block_view.FollowEntry{
...
func (balance *PGCreatorCoinBalance) NewBalanceEntry() *block_view.BalanceEntry {
	return &block_view.BalanceEntry{
...
func (nft *PGNFT) NewNFTEntry() *block_view.NFTEntry {
	return &block_view.NFTEntry{
...
func (bid *PGNFTBid) NewNFTBidEntry() *block_view.NFTBidEntry {
	return &block_view.NFTBidEntry{
...
func (key *PGDerivedKey) NewDerivedKeyEntry() *block_view.DerivedKeyEntry {
	return &block_view.DerivedKeyEntry{
...
func (postgres *Postgres) InsertTransactionsTx(tx *pg.Tx, desoTxns []*network.MsgDeSoTxn, blockNode *BlockNode) error {
	...
	for _, txn := range desoTxns {
		...
		if txn.TxnMeta.GetTxnType() == network.TxnTypeBlockReward {
			...
			txMeta := txn.TxnMeta.(*network.PrivateMessageMetadata)
			...
			txMeta := txn.TxnMeta.(*network.SubmitPostMetadata)
			...
			txMeta := txn.TxnMeta.(*network.UpdateBitcoinUSDExchangeRateMetadataa)
			...
			txMeta := txn.TxnMeta.(*network.FollowMetadata)
			...
			txMeta := txn.TxnMeta.(*network.LikeMetadata)
			...
			txMeta := txn.TxnMeta.(*network.CreatorCoinMetadataa)
...
func (postgres *Postgres) UpsertBlockAndTransactions(blockNode *BlockNode, desoBlock *network.MsgDeSoBlock) error {
	return postgres.db.RunInTransaction(postgres.db.Context(), func(tx *pg.Tx) error {
...
func (postgres *Postgres) FlushView(view *block_view.UtxoView) error {
	return postgres.db.RunInTransaction(postgres.db.Context(), func(tx *pg.Tx) error {
...
func (postgres *Postgres) flushUtxos(tx *pg.Tx, view *block_view.UtxoView) error {
...
func (postgres *Postgres) flushProfiles(tx *pg.Tx, view *block_view.UtxoView) error {
...
func (postgres *Postgres) flushPosts(tx *pg.Tx, view *block_view.UtxoView) error {
...
func (postgres *Postgres) flushLikes(tx *pg.Tx, view *block_view.UtxoView) error {
...
func (postgres *Postgres) flushFollows(tx *pg.Tx, view *block_view.UtxoView) error {
...
func (postgres *Postgres) flushDiamonds(tx *pg.Tx, view *block_view.UtxoView) error {
...
func (postgres *Postgres) flushMessages(tx *pg.Tx, view *block_view.UtxoView) error {
...
func (postgres *Postgres) flushCreatorCoinBalances(tx *pg.Tx, view *block_view.UtxoView) error {
...
func (postgres *Postgres) flushBalances(tx *pg.Tx, view *block_view.UtxoView) error {
...
func (postgres *Postgres) flushForbiddenKeys(tx *pg.Tx, view *block_view.UtxoView) error {
...
func (postgres *Postgres) flushNFTs(tx *pg.Tx, view *block_view.UtxoView) error {
...
func (postgres *Postgres) flushNFTBids(tx *pg.Tx, view *block_view.UtxoView) error {
...
func (postgres *Postgres) flushDerivedKeys(tx *pg.Tx, view *block_view.UtxoView) error {
...
func (postgres *Postgres) GetUtxoEntryForUtxoKey(utxoKey *UtxoKey) *block_view.UtxoEntry {
...
func (postgres *Postgres) GetUtxoEntriesForPublicKey(publicKey []byte) []*block_view.UtxoEntry {
	var transactionOutputs []*PGTransactionOutput
	...
	var utxoEntries []*block_view.UtxoEntry
...
func (postgres *Postgres) InitGenesisBlock(params *DeSoParams, db *badger.DB) error {
	...
	for index, txOutput := range params.SeedBalances {
		_, err := postgres.db.Model(&PGTransactionOutput{
			...
			OutputType:  block_view.UtxoTypeOutput,
