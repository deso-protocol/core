...
func TestNetworkWithOfflineValidators(t *testing.T) {
	...
	node1 := newValidatorNode(uint256.NewInt(0).SetUint64(50), true)  // block proposer
	node2 := newValidatorNode(uint256.NewInt(0).SetUint64(50), false) // validator
	node3 := newValidatorNode(uint256.NewInt(0).SetUint64(50), false) // validator
	node4 := newValidatorNode(uint256.NewInt(0).SetUint64(50), false) // validator
...
func TestNetworkRecoveryAfterCatastrophicFailure(t *testing.T) {
	...
	node1 := newValidatorNode(uint256.NewInt(0).SetUint64(10), true)  // block proposer
	node2 := newValidatorNode(uint256.NewInt(0).SetUint64(10), false) // validator
	node3 := newValidatorNode(uint256.NewInt(0).SetUint64(80), false) // validator
